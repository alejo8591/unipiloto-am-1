	...
	if(webStorage.sessionStorageSupported()){
		...
		if (webStorage.sessionStorageCheck()){
			...
			$('#button-access').bind('click', function(event){
				...
				$.post('http://127.0.0.1:7070/api/v1/user/login', {"email":email, "password":password}, function(data){
	...
	if (webStorage.sessionStorageSupported()){
		...
		if(webStorage.sessionStorageCheck()){
			...
			$('#button-register').bind('click', function(event){
				...
				$.post('http://127.0.0.1:7070/api/v1/user/create',
	...
	$('#button-forgot-password').bind('click', function(event){
		...
		var onConfirm = function(buttonIndex){
			...
			if (buttonIndex === 1){
				...
				$.post('http://127.0.0.1:7070/api/v1/user/' + email + '/update', 
					{
						"password":password,
						"firstname":firstname,
						"lastname":lastname,
